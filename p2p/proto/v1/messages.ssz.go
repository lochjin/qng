...
// Hash: 5cc11d24f2d457e242a02fe669dae889801c02072aed4e9393a45cc457bbc433
// Version: 0.1.2
...
func (t *TransferData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (3) 'Main'
	t.Main = ssz.UnmarshalBool(buf[12:13])

	// Offset (4) 'TokenState'
	if o4 = ssz.ReadOffset(buf[13:17]); o4 > size || o2 > o4 {
		return ssz.ErrOffset
	}
	...
	if err = t.PrevTSHash.UnmarshalSSZ(buf[17:49]); err != nil {
		return err
	}
