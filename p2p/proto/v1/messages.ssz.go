...
// Hash: a6023d5f12e330b50f987ef1e077548f7bfdd63256ac0703ac502661d7e6ab53
// Version: 0.1.2
...
// MarshalSSZ ssz marshals the BytesData object
func (b *BytesData) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BytesData object to a target array
func (b *BytesData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(4)
	...
	// Field (0) 'Data'
	if size := len(b.Data); size > 1048576 {
		err = ssz.ErrBytesLengthFn("BytesData.Data", size, 1048576)
		return
	}
...
// UnmarshalSSZ ssz unmarshals the BytesData object
func (b *BytesData) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 4 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BytesData object
func (b *BytesData) SizeSSZ() (size int) {
	size = 4
...
// HashTreeRoot ssz hashes the BytesData object
func (b *BytesData) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BytesData object with a hasher
func (b *BytesData) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the BytesData object
func (b *BytesData) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(b)
}
...
func (l *Locator) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if dst, err = l.Root.MarshalSSZTo(dst); err != nil {
		return
	}
...
func (l *Locator) UnmarshalSSZ(buf []byte) error {
	...
	if err = l.Root.UnmarshalSSZ(buf[32:64]); err != nil {
		return err
	}
...
func (l *Locator) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	if err = l.Root.HashTreeRootWith(hh); err != nil {
		return
	}
...
func (b *BlockID) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (1) 'Id'
	dst = ssz.MarshalUint32(dst, b.Id)
...
func (b *BlockID) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.Block.UnmarshalSSZ(buf[0:32]); err != nil {
		return err
	}

	// Field (1) 'Id'
	b.Id = ssz.UnmarshallUint32(buf[32:36])
...
func (b *BlockID) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the BlockID object
func (b *BlockID) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(b)
}
...
func (t *TransferData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (2) 'DagBlock'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(t.DagBlock)

	// Offset (3) 'DagBIDs'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(t.DagBIDs) * 36

	// Field (4) 'Main'
	dst = ssz.MarshalBool(dst, t.Main)

	// Offset (5) 'TokenState'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(t.TokenState)

	// Field (6) 'PrevTSHash'
	if t.PrevTSHash == nil {
		t.PrevTSHash = new(Hash)
	}
	if dst, err = t.PrevTSHash.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (0) 'Block'
	if size := len(t.Block); size > 1048576 {
		err = ssz.ErrBytesLengthFn("TransferData.Block", size, 1048576)
		return
	}
	dst = append(dst, t.Block...)

	// Field (1) 'Stxos'
	if size := len(t.Stxos); size > 1048576 {
		err = ssz.ErrBytesLengthFn("TransferData.Stxos", size, 1048576)
		return
	}
	dst = append(dst, t.Stxos...)

	// Field (2) 'DagBlock'
	if size := len(t.DagBlock); size > 1048576 {
		err = ssz.ErrBytesLengthFn("TransferData.DagBlock", size, 1048576)
		return
	}
	dst = append(dst, t.DagBlock...)

	// Field (3) 'DagBIDs'
	if size := len(t.DagBIDs); size > 2000 {
		err = ssz.ErrListTooBigFn("TransferData.DagBIDs", size, 2000)
		return
	}
	for ii := 0; ii < len(t.DagBIDs); ii++ {
		if dst, err = t.DagBIDs[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}

	// Field (5) 'TokenState'
	if size := len(t.TokenState); size > 1048576 {
		err = ssz.ErrBytesLengthFn("TransferData.TokenState", size, 1048576)
		return
	}
	dst = append(dst, t.TokenState...)
...
func (t *TransferData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'Main'
	t.Main = ssz.UnmarshalBool(buf[16:17])

	// Offset (5) 'TokenState'
	if o5 = ssz.ReadOffset(buf[17:21]); o5 > size || o3 > o5 {
		return ssz.ErrOffset
	}
	...
	if err = t.PrevTSHash.UnmarshalSSZ(buf[21:53]); err != nil {
		return err
	}
	...
	// Field (0) 'Block'
	{
		...
		if cap(t.Block) == 0 {
			t.Block = make([]byte, 0, len(buf))
		}
		t.Block = append(t.Block, buf...)
	}
	...
	// Field (1) 'Stxos'
	{
		...
		if cap(t.Stxos) == 0 {
			t.Stxos = make([]byte, 0, len(buf))
		}
		t.Stxos = append(t.Stxos, buf...)
	}
	...
	// Field (2) 'DagBlock'
	{
		...
		if cap(t.DagBlock) == 0 {
			t.DagBlock = make([]byte, 0, len(buf))
		}
		t.DagBlock = append(t.DagBlock, buf...)
	}

	// Field (3) 'DagBIDs'
	{
		buf = tail[o3:o5]
		num, err := ssz.DivideInt2(len(buf), 36, 2000)
		if err != nil {
			return err
		}
		t.DagBIDs = make([]*BlockID, num)
		for ii := 0; ii < num; ii++ {
			if t.DagBIDs[ii] == nil {
				t.DagBIDs[ii] = new(BlockID)
			}
			if err = t.DagBIDs[ii].UnmarshalSSZ(buf[ii*36 : (ii+1)*36]); err != nil {
				return err
			}
		}
	}
	...
	// Field (5) 'TokenState'
	{
		...
		if cap(t.TokenState) == 0 {
			t.TokenState = make([]byte, 0, len(buf))
		}
		t.TokenState = append(t.TokenState, buf...)
	}
	return err
}
...
func (t *TransferData) SizeSSZ() (size int) {
	...
	// Field (3) 'DagBIDs'
	size += len(t.DagBIDs) * 36

	// Field (5) 'TokenState'
	size += len(t.TokenState)
...
func (t *TransferData) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(t.DagBlock))
		if byteLen > 1048576 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.PutBytes(t.DagBlock)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (1048576+31)/32)
	}
	...
	{
		subIndx := hh.Index()
		num := uint64(len(t.DagBIDs))
		if num > 2000 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for _, elem := range t.DagBIDs {
			if err = elem.HashTreeRootWith(hh); err != nil {
				return
			}
		}
	...
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(t.TokenState))
		if byteLen > 1048576 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.PutBytes(t.TokenState)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (1048576+31)/32)
	}
	...
	if err = t.PrevTSHash.HashTreeRootWith(hh); err != nil {
		return
	}
...
func (s *SnapSyncReq) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (0) 'Target'
	if s.Target == nil {
		s.Target = new(Locator)
	}
	if dst, err = s.Target.MarshalSSZTo(dst); err != nil {
		return
	}
...
func (s *SnapSyncReq) UnmarshalSSZ(buf []byte) error {
	...
	if err = s.Target.UnmarshalSSZ(buf[0:64]); err != nil {
		return err
	}
...
func (s *SnapSyncReq) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	if err = s.Target.HashTreeRootWith(hh); err != nil {
		return
	}
...
func (s *SnapSyncRsp) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if dst, err = s.Evm.MarshalSSZTo(dst); err != nil {
		return
	}
	...
	// Field (2) 'Datas'
	if size := len(s.Datas); size > 2000 {
		err = ssz.ErrListTooBigFn("SnapSyncRsp.Datas", size, 2000)
		return
	}
	{
...
func (s *SnapSyncRsp) UnmarshalSSZ(buf []byte) error {
	...
	if err = s.Evm.UnmarshalSSZ(buf[64:96]); err != nil {
		return err
	}
...
func (s *SnapSyncRsp) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	if err = s.Evm.HashTreeRootWith(hh); err != nil {
		return
	}
...
// MarshalSSZ ssz marshals the SyncBlocksReq object
func (s *SyncBlocksReq) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(s)
}

// MarshalSSZTo ssz marshals the SyncBlocksReq object to a target array
func (s *SyncBlocksReq) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(9)

	// Field (0) 'Init'
	dst = ssz.MarshalBool(dst, s.Init)
	...
	if size := len(s.MainLocator); size > 32 {
		err = ssz.ErrListTooBigFn("SyncBlocksReq.MainLocator", size, 32)
		return
	}
...
// UnmarshalSSZ ssz unmarshals the SyncBlocksReq object
func (s *SyncBlocksReq) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 9 {
		return ssz.ErrSize
	...
	// Field (0) 'Init'
	s.Init = ssz.UnmarshalBool(buf[0:1])
...
// SizeSSZ returns the ssz encoded size in bytes for the SyncBlocksReq object
func (s *SyncBlocksReq) SizeSSZ() (size int) {
	size = 9
...
// HashTreeRoot ssz hashes the SyncBlocksReq object
func (s *SyncBlocksReq) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(s)
}

// HashTreeRootWith ssz hashes the SyncBlocksReq object with a hasher
func (s *SyncBlocksReq) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the SyncBlocksReq object
func (s *SyncBlocksReq) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(s)
}

// MarshalSSZ ssz marshals the SyncBlocksRsp object
func (s *SyncBlocksRsp) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(s)
}

// MarshalSSZTo ssz marshals the SyncBlocksRsp object to a target array
func (s *SyncBlocksRsp) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(37)

	// Field (0) 'Complete'
	dst = ssz.MarshalBool(dst, s.Complete)
	...
	// Field (2) 'Blocks'
	if size := len(s.Blocks); size > 1048576 {
		err = ssz.ErrListTooBigFn("SyncBlocksRsp.Blocks", size, 1048576)
		return
	}
	{
...
// UnmarshalSSZ ssz unmarshals the SyncBlocksRsp object
func (s *SyncBlocksRsp) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 37 {
		return ssz.ErrSize
	...
	// Field (0) 'Complete'
	s.Complete = ssz.UnmarshalBool(buf[0:1])

	// Field (1) 'SyncPoint'
	if s.SyncPoint == nil {
		s.SyncPoint = new(Hash)
	}
	if err = s.SyncPoint.UnmarshalSSZ(buf[1:33]); err != nil {
		return err
	}

	// Offset (2) 'Blocks'
	if o2 = ssz.ReadOffset(buf[33:37]); o2 > size {
		return ssz.ErrOffset
	}
	...
	// Field (2) 'Blocks'
	{
		...
		s.Blocks = make([]*BytesData, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if s.Blocks[indx] == nil {
				s.Blocks[indx] = new(BytesData)
			}
...
// SizeSSZ returns the ssz encoded size in bytes for the SyncBlocksRsp object
func (s *SyncBlocksRsp) SizeSSZ() (size int) {
	size = 37
...
// HashTreeRoot ssz hashes the SyncBlocksRsp object
func (s *SyncBlocksRsp) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(s)
}

// HashTreeRootWith ssz hashes the SyncBlocksRsp object with a hasher
func (s *SyncBlocksRsp) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()

	// Field (0) 'Complete'
	hh.PutBool(s.Complete)
...
// GetTree ssz hashes the SyncBlocksRsp object
func (s *SyncBlocksRsp) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(s)
}
