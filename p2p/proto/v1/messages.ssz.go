...
// Hash: e4588b66b5abd2fcf564625bb1c054b6537053d99e932b6ecc6ff6151fcb139c
// Version: 0.1.2
...
func (s *SnapSyncReq) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o3:]
		num, err := ssz.DivideInt2(len(buf), 20, 8)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = s.Status[ii].UnmarshalSSZ(buf[ii*20 : (ii+1)*20]); err != nil {
				return err
			}
		}
	}
...
func (t *TransferStatus) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Start'
	t.Start = ssz.UnmarshallUint64(buf[0:8])

	// Field (1) 'Num'
	t.Num = ssz.UnmarshallUint32(buf[8:12])

	// Field (2) 'Total'
	t.Total = ssz.UnmarshallUint64(buf[12:20])
