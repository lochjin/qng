...
// Hash: c494eb6b750ffb47a2bc69a5bd3797e99c9e324d86cfb6c05822dcbe2e9ccd79
// Version: 0.1.2
...
func (s *SnapSyncRsp) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'Datas'
	if size := len(s.Datas); size > 1048576 {
		err = ssz.ErrBytesLengthFn("SnapSyncRsp.Datas", size, 1048576)
		return
	}
	dst = append(dst, s.Datas...)
...
func (s *SnapSyncRsp) UnmarshalSSZ(buf []byte) error {
	...
	// Field (3) 'Datas'
	{
		...
		if cap(s.Datas) == 0 {
			s.Datas = make([]byte, 0, len(buf))
		}
		s.Datas = append(s.Datas, buf...)
	}
	return err
}
