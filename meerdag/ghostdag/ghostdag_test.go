...
func (b *TestBlockHeadersStore) Stage(stagingArea *cmodel.StagingArea, blockHash *hash.Hash, blockHeader model.BlockHeader) {
	b.dagMap[*blockHash] = blockHeader
}

func (b *TestBlockHeadersStore) IsStaged(*cmodel.StagingArea) bool { panic("unimplemented") }

func (b *TestBlockHeadersStore) BlockHeader(dbContext model.DBReader, stagingArea *cmodel.StagingArea, blockHash *hash.Hash) (model.BlockHeader, error) {
...
func (b *TestBlockHeadersStore) HasBlockHeader(dbContext model.DBReader, stagingArea *cmodel.StagingArea, blockHash *hash.Hash) (bool, error) {
	_, ok := b.dagMap[*blockHash]
	return ok, nil
}

func (b *TestBlockHeadersStore) BlockHeaders(dbContext model.DBReader, stagingArea *cmodel.StagingArea, blockHashes []*hash.Hash) ([]model.BlockHeader, error) {
...
func (b *TestBlockHeadersStore) Delete(stagingArea *cmodel.StagingArea, blockHash *hash.Hash) {
	delete(b.dagMap, *blockHash)
}

func (b *TestBlockHeadersStore) Count(*cmodel.StagingArea) uint64 {
...
func (ds *TestGHOSTDAGDataStore) Stage(stagingArea *cmodel.StagingArea, blockHash *hash.Hash, blockGHOSTDAGData *model.BlockGHOSTDAGData, isTrustedData bool) {
	ds.dagMap[*blockHash] = blockGHOSTDAGData
}

func (ds *TestGHOSTDAGDataStore) IsStaged(*cmodel.StagingArea) bool {
	panic("implement me")
}
...
func (ds *TestGHOSTDAGDataStore) Get(dbContext model.DBReader, stagingArea *cmodel.StagingArea, blockHash *hash.Hash, isTrustedData bool) (*model.BlockGHOSTDAGData, error) {
...
func (ds *TestGHOSTDAGDataStore) UnstageAll(stagingArea *cmodel.StagingArea) {
	panic("implement me")
}
...
func (dt *TestDAGTopologyManage) ChildInSelectedParentChainOf(stagingArea *cmodel.StagingArea, lowHash, highHash *hash.Hash) (*hash.Hash, error) {
	panic("implement me")
}
...
func (dt *TestDAGTopologyManage) Parents(stagingArea *cmodel.StagingArea, blockHash *hash.Hash) ([]*hash.Hash, error) {
...
func (dt *TestDAGTopologyManage) Children(stagingArea *cmodel.StagingArea, blockHash *hash.Hash) ([]*hash.Hash, error) {
	panic("unimplemented")
}

func (dt *TestDAGTopologyManage) IsParentOf(stagingArea *cmodel.StagingArea, blockHashA *hash.Hash, blockHashB *hash.Hash) (bool, error) {
	panic("unimplemented")
}

func (dt *TestDAGTopologyManage) IsChildOf(stagingArea *cmodel.StagingArea, blockHashA *hash.Hash, blockHashB *hash.Hash) (bool, error) {
	panic("unimplemented")
}

func (dt *TestDAGTopologyManage) IsAncestorOf(stagingArea *cmodel.StagingArea, blockHashA *hash.Hash, blockHashB *hash.Hash) (bool, error) {
...
func (dt *TestDAGTopologyManage) IsAncestorOfAny(stagingArea *cmodel.StagingArea, blockHash *hash.Hash, potentialDescendants []*hash.Hash) (bool, error) {
	panic("unimplemented")
}
func (dt *TestDAGTopologyManage) IsAnyAncestorOf(*cmodel.StagingArea, []*hash.Hash, *hash.Hash) (bool, error) {
	panic("unimplemented")
}
func (dt *TestDAGTopologyManage) IsInSelectedParentChainOf(stagingArea *cmodel.StagingArea, blockHashA *hash.Hash, blockHashB *hash.Hash) (bool, error) {
	panic("unimplemented")
}

func (dt *TestDAGTopologyManage) SetParents(stagingArea *cmodel.StagingArea, blockHash *hash.Hash, parentHashes []*hash.Hash) error {
	panic("unimplemented")
}
