	...
	for {
		...
		for _, edge := range r.graph.edges {
			if edge.From == currentNode {
				currentNode = edge.To(ctx, state, graphOpts)
				foundNext = true
				break
			}
		}
